...
This chapter focuses on how to optimizing common applications when using Shiny.
...
```{r reactivity,echo=FALSE, fig.align='center', fig.cap='[Reactivity an overview](https://shiny.rstudio.com/articles/reactivity-overview.html)', out.width='80%'}
...
```{r recursive,echo=FALSE, fig.align='center', fig.cap='Recursivity', out.width='80%'}
...
```{r observe,echo=FALSE, fig.align='center', fig.cap='Recursivity', out.width='80%'}
...
```{r whereami,echo=FALSE, fig.align='center', fig.cap='{whereami} package', fig.alt="{whereami}",out.width='30%'}
...
```{r cat_where, eval=FALSE, include=T}
cat_where(where, 
...
```{r cat_where_counter_plot, eval=FALSE, include=T}
whereami::counter_get()
plot(whereami::counter_get())
```
      
```{r counterplot,echo=FALSE, fig.align='center', fig.cap='{whereami} package', fig.alt="plot of whereami counters",out.width='80%'}
...
```{r sources,echo=FALSE, fig.align='center', fig.cap='Data-source checklist', out.width='80%'}
